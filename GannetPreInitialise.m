...
%Acquisition Parameters
   ...
   % MRS_struct.p.sw=5000; %This should be parsed from headers where possible
    ...
    MRS_struct.p.target='GABAGlx'; %Other options are 'GSH' and 'Glx' (now also implemented) 'GABAGlx' in dev
    ...
    MRS_struct.p.Siemens_type = 4; %1 = TIM TRIO WIP 2 = Near seq 3 =Skyra WIP; 4=Prisma (VD13C); 5=Prisma(Minnesota); 6 = Jamie's VE11B (Jena); 7 = Minnesota (VE11C)
